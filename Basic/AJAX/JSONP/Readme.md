![WCF_Practice_Basic_AJAX_JSONP]([https://github.com/niisar/WCF/blob/master/Basic/AJAX/JSONP/img_jsonp.JPG](https://github.com/niisar/WCF/blob/master/Basic/AJAX/JSONP/img_jsonp.JPG))
